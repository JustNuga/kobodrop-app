...
const Hero = () => {
  return (
    <section className="mt-4 flex h-fit max-w-7xl flex-col relative items-center gap-10 px-8 sm:gap-16 md:my-0 md:h-{85vh} md:flex-row md:gap-0 lg:px-12 xl:m-auto xl:gap-0 xl:overflow-hidden">
      <div className="sm:w-full md:w-3/6">
        <h1 className="text-center mx-auto mb-8 w-[12ch] text-4xl font-semibold text-gray-800 sm:text-5xl md:mx-0 md:text-left">
      ...
      <div className="md:w-3/6 xl:mb-12 xl:overflow-hidden">
        ...
        <img
          ...
          src={HeroImg}
          alt="Woman happily using Kobodrp"
        />
      </div>
    </section>
  );
